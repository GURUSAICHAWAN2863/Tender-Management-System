...
<html lang="en">
  <head>
    <link rel="shortcut icon" type="image/png" href="images/sun1.png">
        ...
        <div class="container" >
            <div class="navbar-header my-1"> <!-- Header navigation-->
                <a href="#" class="pull-left">
                    <img src="images/sun1.png" alt="image" width="70px" height="70px"/>
                </a>
                    <a class="navbar-brand" href="#"><h1>Tender Management System</h1></a> <!-- Library Name fixed-->
                   <a href="#"><p style="color:black;">Project</p></a>
            </div>
